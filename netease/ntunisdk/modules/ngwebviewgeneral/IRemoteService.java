...
public interface IRemoteService extends IInterface {
    void register(IRemoteCallback iRemoteCallback) throws RemoteException;

    void send(String str) throws RemoteException;

    public static abstract class Stub extends Binder implements IRemoteService {
        private static final String DESCRIPTOR = "com.netease.ntunisdk.modules.ngwebviewgeneral.IRemoteService";
        ...
        public static IRemoteService asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IRemoteService)) {
                return (IRemoteService) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                register(IRemoteCallback.Stub.asInterface(parcel.readStrongBinder()));
        ...
        private static class Proxy implements IRemoteService {
            ...
            public void register(IRemoteCallback iRemoteCallback) throws RemoteException {
