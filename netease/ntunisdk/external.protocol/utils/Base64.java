...
public class Base64 {
    ...
    public static String encodeToString(byte[] bArr, int i) {
        if (Build.VERSION.SDK_INT >= 19) {
            return new String(encode(bArr, i), StandardCharsets.US_ASCII);
        }
        try {
    ...
    public static String encodeToString(byte[] bArr, int i, int i2, int i3) {
        if (Build.VERSION.SDK_INT >= 19) {
            return new String(encode(bArr, i, i2, i3), StandardCharsets.US_ASCII);
        }
        try {
            return new String(encode(bArr, i3), StringUtil.US_ASCII);
        } catch (Exception unused) {
            return new String(encode(bArr, i3));
        }
    }
    ...
    static class Decoder extends Coder {
        ...
        @Override // com.netease.ntunisdk.external.protocol.utils.Base64.Coder
    ...
    static class Encoder extends Coder {
        ...
        */
        public boolean process(byte[] r18, int r19, int r20, boolean r21) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: com.netease.ntunisdk.external.protocol.utils.Base64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
}