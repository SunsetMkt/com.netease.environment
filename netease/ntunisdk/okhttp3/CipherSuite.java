...
public final class CipherSuite {
    ...
    static final Comparator<String> ORDER_BY_NAME = new Comparator<String>() { // from class: com.netease.ntunisdk.okhttp3.CipherSuite.1
    ...
    public static final CipherSuite TLS_PSK_WITH_RC4_128_SHA = init("TLS_PSK_WITH_RC4_128_SHA", WKSRecord.Service.NETBIOS_DGM);
    public static final CipherSuite TLS_PSK_WITH_3DES_EDE_CBC_SHA = init("TLS_PSK_WITH_3DES_EDE_CBC_SHA", WKSRecord.Service.NETBIOS_SSN);
    public static final CipherSuite TLS_PSK_WITH_AES_128_CBC_SHA = init("TLS_PSK_WITH_AES_128_CBC_SHA", WKSRecord.Service.EMFIS_DATA);
    public static final CipherSuite TLS_PSK_WITH_AES_256_CBC_SHA = init("TLS_PSK_WITH_AES_256_CBC_SHA", WKSRecord.Service.EMFIS_CNTL);
    public static final CipherSuite TLS_RSA_WITH_SEED_CBC_SHA = init("TLS_RSA_WITH_SEED_CBC_SHA", SDefine.fK);
    ...
    public static final CipherSuite TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = init("TLS_DHE_DSS_WITH_AES_128_GCM_SHA256", CaptureActivity.RESULT_CODE_QR_ALBUM);
