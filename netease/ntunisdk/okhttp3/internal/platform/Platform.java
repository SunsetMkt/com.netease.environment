...
import com.netease.ntunisdk.okhttp3.internal.tls.BasicCertificateChainCleaner;
import com.netease.ntunisdk.okhttp3.internal.tls.BasicTrustRootIndex;
import com.netease.ntunisdk.okhttp3.internal.tls.CertificateChainCleaner;
import com.netease.ntunisdk.okhttp3.internal.tls.TrustRootIndex;
...
public class Platform {
    ...
    protected X509TrustManager trustManager(SSLSocketFactory sSLSocketFactory) throws IllegalAccessException, NoSuchFieldException, IllegalArgumentException {
        System.out.println("wuln--okhttp Platform [trustManager] start");
        try {
