package com.netease.ntunisdk.okhttp3.internal.publicsuffix;
...
public final class PublicSuffixDatabase {
    ...
    private String[] findMatchingRule(String[] strArr) throws InterruptedException {
        ...
        if (str != null) {
            return ("!" + str).split(z.f2789a);
        }
        if (strBinarySearchBytes == null && strBinarySearchBytes2 == null) {
            return PREVAILING_RULE;
        }
        String[] strArrSplit = strBinarySearchBytes != null ? strBinarySearchBytes.split(z.f2789a) : EMPTY_RULE;
        String[] strArrSplit2 = strBinarySearchBytes2 != null ? strBinarySearchBytes2.split(z.f2789a) : EMPTY_RULE;
    ...
    public String getEffectiveTldPlusOne(String str) throws InterruptedException {
        ...
        String[] strArrSplit = IDN.toUnicode(str).split(z.f2789a);
        ...
        String[] strArrSplit2 = str.split(z.f2789a);
