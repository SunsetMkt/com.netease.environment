...
import com.netease.ntunisdk.okio.GzipSource;
...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        if (request.header(Const.HEADER_ACCEPT_ENCODING) == null && request.header("Range") == null) {
            builderNewBuilder.header(Const.HEADER_ACCEPT_ENCODING, Const.ACCEPT_ENCODING_GZIP);
            z = true;
        }
        ...
        if (z && Const.ACCEPT_ENCODING_GZIP.equalsIgnoreCase(responseProceed.header("Content-Encoding")) && HttpHeaders.hasBody(responseProceed)) {
