...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new Comparator<String>() { // from class: com.netease.ntunisdk.okhttp3.internal.Util.1
        AnonymousClass1() {
        }
    ...
    /* renamed from: com.netease.ntunisdk.okhttp3.internal.Util$1 */
    ...
    /* renamed from: com.netease.ntunisdk.okhttp3.internal.Util$2 */
    ...
    public static String canonicalizeHost(String str) {
        ...
        InetAddress inetAddressDecodeIpv6 = (str.startsWith(Constants.C) && str.endsWith("]")) ? decodeIpv6(str, 1, str.length() - 1) : decodeIpv6(str, 0, str.length());
    ...
    */
    private static java.net.InetAddress decodeIpv6(java.lang.String r11, int r12, int r13) {
        ...
        L90:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netease.ntunisdk.okhttp3.internal.Util.decodeIpv6(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    public static String hostHeader(HttpUrl httpUrl, boolean z) {
        ...
        if (httpUrl.host().contains(":")) {
            strHost = Constants.C + httpUrl.host() + "]";
        } else {
    ...
    public static ThreadFactory threadFactory(String str, boolean z) {
        return new ThreadFactory() { // from class: com.netease.ntunisdk.okhttp3.internal.Util.2
            final /* synthetic */ boolean val$daemon;
            final /* synthetic */ String val$name;
