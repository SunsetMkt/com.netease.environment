package com.netease.ntunisdk.okhttp3.internal.ws;
...
import com.netease.ntunisdk.okhttp3.WebSocketListener;
...
import com.netease.ntunisdk.okhttp3.internal.ws.WebSocketReader;
...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random, long j) {
        ...
        this.writerRunnable = new Runnable() { // from class: com.netease.ntunisdk.okhttp3.internal.ws.RealWebSocket.1
            @Override // java.lang.Runnable
            public void run() throws IOException {
                do {
                    try {
    ...
    @Override // com.netease.ntunisdk.okhttp3.WebSocket
    public void cancel() {
        this.call.cancel();
    }
    ...
    public void connect(OkHttpClient okHttpClient) {
        ...
        this.call.enqueue(new Callback() { // from class: com.netease.ntunisdk.okhttp3.internal.ws.RealWebSocket.2
    ...
    @Override // com.netease.ntunisdk.okhttp3.internal.ws.WebSocketReader.FrameCallback
