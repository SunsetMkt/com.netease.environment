package com.netease.ntunisdk.okhttp3.internal.http1;
...
import com.netease.ntunisdk.okio.ForwardingTimeout;
...
public final class Http1Codec implements HttpCodec {
    ...
    private final class ChunkedSink implements Sink {
        ...
        public void write(Buffer buffer, long j) throws IOException {
            ...
            Http1Codec.this.sink.writeUtf8(CharsetUtil.CRLF);
    ...
    private class ChunkedSource extends AbstractSource {
        ...
        @Override // com.netease.ntunisdk.okhttp3.internal.http1.Http1Codec.AbstractSource, com.netease.ntunisdk.okio.Source
        public long read(Buffer buffer, long j) throws IOException {
            if (j < 0) {
    ...
    public void writeRequest(Headers headers, String str) throws IOException {
        ...
        for (int i = 0; i < size; i++) {
            this.sink.writeUtf8(headers.name(i)).writeUtf8(": ").writeUtf8(headers.value(i)).writeUtf8(CharsetUtil.CRLF);
        }
