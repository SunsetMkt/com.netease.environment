...
import com.netease.ntunisdk.okhttp3.internal.cache.CacheRequest;
import com.netease.ntunisdk.okhttp3.internal.cache.CacheStrategy;
import com.netease.ntunisdk.okhttp3.internal.cache.DiskLruCache;
...
import com.netease.ntunisdk.okhttp3.internal.http.HttpMethod;
import com.netease.ntunisdk.okhttp3.internal.http.StatusLine;
import com.netease.ntunisdk.okhttp3.internal.io.FileSystem;
...
import com.netease.ntunisdk.okio.ForwardingSource;
...
public final class Cache implements Closeable, Flushable {
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(final DiskLruCache.Editor editor) {
            ...
            this.body = new ForwardingSink(this.cacheOut) { // from class: com.netease.ntunisdk.okhttp3.Cache.CacheRequestImpl.1
        ...
        @Override // com.netease.ntunisdk.okhttp3.internal.cache.CacheRequest
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(final DiskLruCache.Snapshot snapshot, String str, String str2) {
            ...
            this.bodySource = Okio.buffer(new ForwardingSource(snapshot.getSource(1)) { // from class: com.netease.ntunisdk.okhttp3.Cache.CacheResponseBody.1
                @Override // com.netease.ntunisdk.okio.ForwardingSource, com.netease.ntunisdk.okio.Source, java.io.Closeable, java.lang.AutoCloseable
                public void close() throws IOException {
                    snapshot.close();
                    super.close();
                }
    ...
    private static final class Entry {
        ...
        private List<Certificate> readCertificateList(BufferedSource bufferedSource) throws IOException, CertificateException {
            ...
            try {
                CertificateFactory certificateFactory = CertificateFactory.getInstance(RSASignature.d);
    ...
    Cache(File file, long j, FileSystem fileSystem) {
        this.internalCache = new InternalCache() { // from class: com.netease.ntunisdk.okhttp3.Cache.1
            @Override // com.netease.ntunisdk.okhttp3.internal.cache.InternalCache
    ...
    static int readInt(BufferedSource bufferedSource) throws IOException {
        try {
            ...
            String utf8LineStrict = bufferedSource.readUtf8LineStrict();
            if (decimalLong >= 0 && decimalLong <= TTL.MAX_VALUE && utf8LineStrict.isEmpty()) {
    ...
    public Iterator<String> urls() throws IOException {
        return new Iterator<String>() { // from class: com.netease.ntunisdk.okhttp3.Cache.2
            boolean canRemove;
