...
import com.netease.ntunisdk.okhttp3.internal.publicsuffix.PublicSuffixDatabase;
...
public final class HttpUrl {
        ...
        Builder parse(@Nullable HttpUrl httpUrl, String str) throws NumberFormatException {
            ...
            if (iSlashCount >= 2 || httpUrl == null || !httpUrl.scheme.equals(this.scheme)) {
                ...
                while (true) {
                    ...
                    char cCharAt = iDelimiterOffset != iSkipTrailingAsciiWhitespace ? str.charAt(iDelimiterOffset) : '\uffff';
                    if (cCharAt == '\uffff' || cCharAt == c2 || cCharAt == '/' || cCharAt == '\\' || cCharAt == c) {
                        break;
                    }
                    if (cCharAt == '@') {
                        if (z) {
    ...
    public static int defaultPort(String str) {
        ...
        if (str.equals("https")) {
            return com.JavaWebsocket.WebSocket.DEFAULT_WSS_PORT;
        }
        return -1;
    }
    ...
    */
    static void percentDecode(com.netease.ntunisdk.okio.Buffer r5, java.lang.String r6, int r7, int r8, boolean r9) {
        /*
        L0:
            if (r7 >= r8) goto L42
            ...
            int r2 = com.netease.ntunisdk.okhttp3.internal.Util.decodeHexDigit(r2)
            char r3 = r6.charAt(r1)
            int r3 = com.netease.ntunisdk.okhttp3.internal.Util.decodeHexDigit(r3)
            r4 = -1
            if (r2 == r4) goto L39
            if (r3 == r4) goto L39
            int r7 = r2 << 4
        ...
        L42:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.netease.ntunisdk.okhttp3.HttpUrl.percentDecode(com.netease.ntunisdk.okio.Buffer, java.lang.String, int, int, boolean):void");
    }
