...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j) throws IOException {
        ...
        Buffer bufferM523clone = bufferedSourceSource.buffer().m523clone();
        if (bufferM523clone.size() > j) {
            Buffer buffer = new Buffer();
            buffer.write(bufferM523clone, j);
            bufferM523clone.clear();
            bufferM523clone = buffer;
        }
        return ResponseBody.create(this.body.contentType(), bufferM523clone.size(), bufferM523clone);
    }
