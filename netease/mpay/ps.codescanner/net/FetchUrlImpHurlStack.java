    ...
    protected FetchUrl.FetchUrlResponse fetchUrlRaw(int i, String str, HashMap<String, String> map, byte[] bArr, int i2, int i3) throws FetchUrl.FetchUrlException, IOException {
        ...
        try {
            try {
                ...
                if (errorStream != null) {
                    fetchUrlResponse.content = Utils.inputStreamToByteArray(errorStream);
                }
                ...
                Logging.log("fetchUrlRaw: " + str + "\n===> " + fetchUrlResponse.code + " " + new String(fetchUrlResponse.content));
